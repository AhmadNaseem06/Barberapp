            ...
            children: <Widget>[
                ...
                children: [
                  Row(
                    children: [
                      ...
                      8.width,
                      Text('Ahmad Naseem,', style: TextStyle(fontSize: 18, color: BHColorPrimary, fontWeight: FontWeight.bold)),
                    ],
                  ),
                  GestureDetector(
              ...
              Row(
                children: [
                  ...
                  8.width,
                  Text('Allama Iqbal Colony, Rawalpindi', style: secondaryTextStyle()),
                ],
              ),
              8.height,
              Row(
