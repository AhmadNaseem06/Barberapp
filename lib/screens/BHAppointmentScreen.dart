...
import 'package:prokit/utils/BHWidgets.dart';
import 'package:nb_utils/nb_utils.dart';
import 'package:prokit/utils/BHColors.dart';
import 'package:prokit/utils/BHConstants.dart';
import 'package:prokit/utils/BHImages.dart';
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Razors & Scissors - F7', style: boldTextStyle(size: 14)),
                          8.height,
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Icon(Icons.location_on, size: 14, color: BHAppTextColorSecondary).paddingOnly(top: 2),
                              Text('Flat #6,Jinnah Super Market, F-7 Markaz, Islamabad', style: secondaryTextStyle(size: 12)).expand(),
                            ],
                          ),
                        ],
                      ).expand(),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text('Hair Saloon', style: boldTextStyle(size: 14)),
                  ...
                  Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Shamas', style: secondaryTextStyle()),
                      ),
                    ],
                  ),
                  Row(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Mister Cutts ', style: boldTextStyle(size: 14)),
                          8.height,
                          Row(
                            children: [
                              Icon(Icons.location_on, size: 14, color: BHAppTextColorSecondary),
                              4.width,
                              Text(' Islamabad', style: secondaryTextStyle()),
                            ],
                          ),
                        ],
                      ),
                  ...
                  8.height,
                  Text('Makeup Artist', style: secondaryTextStyle()),
                  8.height,
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Row(
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.only(left: 4),
                            child: Text('Malik Adeel', style: secondaryTextStyle()),
                          ),
                        ],
                      ),
