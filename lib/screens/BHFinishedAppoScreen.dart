              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Overhair salon', style: boldTextStyle(size: 14)),
                      8.height,
                      Row(
                        children: [
                          Icon(Icons.location_on, size: 14, color: BHAppTextColorSecondary),
                          8.width,
                          Text('Above Coffee Planet Overhair Salon, Islamabad', style: secondaryTextStyle()),
                        ],
                      ),
                      8.height,
                      ...
                      Row(
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text('Shabir Ahmad', style: secondaryTextStyle()),
                          ),
                        ],
                      ),
