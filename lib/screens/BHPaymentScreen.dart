                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Akbar Hair Saloon', style: boldTextStyle(size: 14)),
                            8.height,
                            Row(
                              children: [
                                Icon(Icons.location_on, size: 14, color: BHAppTextColorSecondary),
                                Text(
                                  'Markaz Road, Korang Road, Islamabad.',
                    ...
                    Row(
                      ...
                      children: [
                        Text('Makeup Artist', style: boldTextStyle(size: 14)),
                    ...
                    Row(
                      children: [
                        ...
                        Text('Malik Taimoor', style: TextStyle(color: BHAppTextColorSecondary, fontSize: 14)).paddingOnly(left: 4),
                      ],
                    ),
                    16.height,
                    Row(
                      ...
                      children: [
                        ...
                        Text('Rs250', style: boldTextStyle(size: 14)),
                      ],
                    ),
                    Container(
                      height: 1,
