...
import 'package:prokit/model/BHModel.dart';
...
List<BHBestSpecialModel> getSpecialList() {
  ...
  list.add(BHBestSpecialModel(title: 'Malik Javed', subTitle: 'Makeup Artist', img: BHdDashedBoardImage5));
  list.add(BHBestSpecialModel(title: 'Adeel Khan', subTitle: 'Hire Stylist', img: BHDashedBoardImage1));
  list.add(BHBestSpecialModel(title: 'Shahid khan', subTitle: 'Barber', img: BHDashedBoardImage6));
  list.add(BHBestSpecialModel(title: 'Muhammad Shahid', subTitle: 'Makeup Artist', img: BHDashedBoardImage3));
  list.add(BHBestSpecialModel(title: 'Ziafat Hussain', subTitle: 'Makeup Artist', img: BHDashedBoardImage3));
  list.add(BHBestSpecialModel(title: 'Shahid Gujjar', subTitle: 'Hire Stylist', img: BHdDashedBoardImage5));
  list.add(BHBestSpecialModel(title: 'Abdul wahab', subTitle: 'Barber', img: BHDashedBoardImage1));
  list.add(BHBestSpecialModel(title: 'Uzair', subTitle: 'Makeup Artist', img: BHDashedBoardImage6));
...
List<BHBestSpecialModel> getSpecialNewList() {
  List<BHBestSpecialModel> list = [];
  list.add(BHBestSpecialModel(title: 'Jawad', subTitle: 'Makeup Artist', img: BHdDashedBoardImage5));
  list.add(BHBestSpecialModel(title: 'Ali', subTitle: 'Hire Stylist', img: BHDashedBoardImage1));
  list.add(BHBestSpecialModel(title: 'Shahid Khan', subTitle: 'Barber', img: BHDashedBoardImage6));
  list.add(BHBestSpecialModel(title: 'Naeem', subTitle: 'Makeup Artist', img: BHDashedBoardImage3));
  list.add(BHBestSpecialModel(title: 'Saad Bhatti', subTitle: 'Hire Stylist', img: BHDashedBoardImage2));
  list.add(BHBestSpecialModel(title: 'Shaukat', subTitle: 'Barber', img: BHDashedBoardImage6));
  return list;
}

List<BHSpecialOfferModel> getSpecialOfferList() {
  List<BHSpecialOfferModel> specialOfferList = [];
  specialOfferList.add(BHSpecialOfferModel(img: BHdDashedBoardImage5, title: 'Shahid Salon', subtitle: 'Cool Summer Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage3, title: 'Barber Hair ', subtitle: 'Cool Winter Event'));
  ...
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage1, title: 'Malik Adeeel', subtitle: 'Cool Winter Event'));
...
List<BHSpecialOfferModel> getSpecialOfferNewList() {
  List<BHSpecialOfferModel> specialOfferList = [];
  specialOfferList.add(BHSpecialOfferModel(img: BHdDashedBoardImage5, title: 'Pak Hair Salon', subtitle: 'Cool Summer Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage3, title: 'Razors & Scissors', subtitle: 'Cool Winter Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage6, title: 'Nwaz Hair Salon', subtitle: 'Cool Winter Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage7, title: 'DHA barber Sshop', subtitle: 'Cool Winter Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage1, title: 'Fresh Fades', subtitle: 'Cool Winter Event'));
  return specialOfferList;
}

List<MessageModel> getMessageList() {
  List<MessageModel> messageList = [];
  messageList.add(MessageModel(img: BHDashedBoardImage3, name: 'Malik Barber Shop', message: 'Hi Jackson..', lastSeen: 'Now'));
  messageList.add(MessageModel(img: BHDashedBoardImage2, name: 'habib', message: 'Thank you.', lastSeen: '8:30 AM'));
...
List<BHReviewModel> getReviewList() {
  ...
  reviewList.add(BHReviewModel(img: BHDashedBoardImage1, name: 'Bashir', rating: 4.5, day: '4 Day ago', review: BHReview));
  reviewList.add(BHReviewModel(img: BHUserImg, name: 'Sherman', rating: 2.5, day: '10 Day ago', review: BHReview));
  reviewList.add(BHReviewModel(img: BHUserImg, name: 'Shamas Saloon', rating: 4, day: '1 Day ago', review: BHReview));
...
List<BHHairStyleModel> getHairStyleList() {
  ...
  hairStyleList.add(BHHairStyleModel(img: BHDashedBoardImage2, name: 'Uzair'));
  hairStyleList.add(BHHairStyleModel(img: BHDashedBoardImage6, name: 'Muhhamad Saad'));
  hairStyleList.add(BHHairStyleModel(img: BHDashedBoardImage1, name: 'Waleed'));
  return hairStyleList;
}

List<BHMakeUpModel> getMakeupList() {
  List<BHMakeUpModel> makeupList = [];
  makeupList.add(BHMakeUpModel(img: BHDashedBoardImage3, name: 'Hasnain Saloon'));
  ...
  makeupList.add(BHMakeUpModel(img: BHDashedBoardImage1, name: 'Akhtar Khan'));
  return makeupList;
}
...
List<BHNotificationModel> getNotificationList() {
  ...
  notificationList.add(BHNotificationModel(img: BHDashedBoardImage3, name: 'Ahmad  Salon', msg: 'Hello', status: 'Yesterday', callInfo: BHCallIcon));
...
List<BHNotifyModel> getNotifyList() {
  ...
  notifyList.add(
    BHNotifyModel(img: BHDashedBoardImage4, name: 'Norah Beauty Salon', address: 'Allama Iqbal Colony, Rawalpindi.', rating: 4.5, distance: 7.5),
  );
  notifyList.add(
    BHNotifyModel(img: BHDashedBoardImage1, name: 'Sherman Barber Shop', address: 'Allama Iqbal Colony, Rawalpindi.', rating: 3.5, distance: 14.2),
  );
  notifyList.add(
    BHNotifyModel(img: BHDashedBoardImage3, name: 'Hasnain Ziafat', address: 'Allama Iqbal Colony, Rawalpindi.', rating: 2.0, distance: 10.0),
  );
  notifyList.add(
    BHNotifyModel(img: BHdDashedBoardImage5, name: 'Norah Beauty Salon', address: 'Shaley Valey, Rawalpindi', rating: 5.0, distance: 17.5),
  );
  notifyList.add(
    BHNotifyModel(img: BHDashedBoardImage6, name: 'Barber King', address: 'Shaley Valey, Rawalpindi.', rating: 3.5, distance: 11.0),
  );
  return notifyList;
}
